...
const CONTACT_ITEM_SELECTOR = '.contactItemSelector';
const DELETE_BTN_CLASS = 'deleteBtnClass';
const EDIT_BTN_CLASS = 'editBtnClass';

const contactForm = document.querySelector('#contactForm');
const inputs = document.querySelectorAll('.formInput');
const contactListEl = document.querySelector('#contactListEl');
